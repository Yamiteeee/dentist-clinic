...
function ToothIcon({ className }: { className?: string }) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M12 2C8 2 6 4 6 8c0 3.5 1 6.5 2 10 0.8 2.8 2.2 4 4 4s3.2-1.2 4-4c1-3.5 2-6.5 2-10 0-4-2-6-6-6z" />
        ...
        <div className={styles.grid}>
          ...
          <div className={styles.brandCol}>
            <div className={styles.logo}>
              ...
              <span className={styles.logoText}>{footerData.clinicName}</span>
            </div>
            ...
            <ul className={styles.hoursList}>
              {footerData.hours.map((item) => (
                <li key={item.days} className={styles.hourRow}>
                  ...
                  <div>
                    <span className={styles.dayLabel}>{item.days}:</span>{' '}
